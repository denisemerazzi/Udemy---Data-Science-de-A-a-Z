    CURSO UDEMY - FELIPE MAFRA: Módulo de Python

* Python é uma linguagem "fácil", interpretativa (windows, Mac, Linux), portátil, para fins gerais, comunidade ativa, programadores no mundo (constante melhoria).

* Bibliotecas Python: "Módulos" (comunidade ativa no mundo inteiro). Ex: Matplotlib, Pandas, Jupyter, Numpy, Sympy, ScikitLearn, SciPy.
